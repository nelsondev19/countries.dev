  ...
  return (
    <main className="p-3">
      <div className="h-[80vh] grid place-content-center">
        <div className="flex justify-center items-center gap-2 px-3 py-[9px] mb-10 mx-80 w-auto bg-transparent-effect duration-300 text-center font-semibold rounded-xl border border-gray-700 hover:border-gray-600">
          <span id="endpoint" className="text-sm">{text}</span>
        ...
        <p
          id="description"
          className="text-center text-xl max-w-screen-md m-auto mt-4"
        >
